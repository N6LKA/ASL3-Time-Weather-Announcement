...
# Supermon's link.php calls /usr/local/sbin/weather.sh directly.
ln -sf "$INSTALL_DIR/weather.sh" /usr/local/sbin/weather.sh
echo "Supermon symlink: /usr/local/sbin/weather.sh -> $INSTALL_DIR/weather.sh"
